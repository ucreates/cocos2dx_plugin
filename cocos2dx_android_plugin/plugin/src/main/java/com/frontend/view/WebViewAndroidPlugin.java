...
import com.frontend.activity.ActivityAndroidPlugin;
import com.core.identifier.TagAndroidPlugin;
public class WebViewAndroidPlugin {
    ...
    public void create(String requestUrl, int left, int top, int right, int bottom) {
        final Activity activity = ActivityAndroidPlugin.getInstance();
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                view.setBackgroundColor(WebViewAndroidPlugin.TRANSPARENT_BACK_GROUND_COLOR);
                ...
                WebViewClient client = new WebViewClient() {
                    ...
                    public boolean shouldOverrideUrlLoading(WebView view, String url) {
                        Log.i(TagAndroidPlugin.PLUGIN_IDENTIFIER, url);
                        return false;
                    }
                };
