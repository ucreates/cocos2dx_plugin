...
int lua_pluginx_protocols_PluginManager_unloadPlugin(lua_State* tolua_S) {
    ...
    if (argc == 1) {
        const char* arg0;
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "plugin.PluginManager:unloadPlugin");
        arg0 = arg0_tmp.c_str();
        if (!ok) {
...
int lua_pluginx_protocols_PluginManager_loadPlugin(lua_State* tolua_S) {
    ...
    if (argc == 1) {
        const char* arg0;
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "plugin.PluginManager:loadPlugin");
        arg0 = arg0_tmp.c_str();
        if (!ok) {
...
int lua_pluginx_protocols_ProtocolAnalytics_logTimedEventBegin(lua_State* tolua_S) {
    ...
    if (argc == 1) {
        const char* arg0;
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "plugin.ProtocolAnalytics:logTimedEventBegin");
        arg0 = arg0_tmp.c_str();
        if (!ok) {
...
int lua_pluginx_protocols_ProtocolAnalytics_logError(lua_State* tolua_S) {
    ...
    if (argc == 2) {
        ...
        const char* arg1;
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "plugin.ProtocolAnalytics:logError");
        arg0 = arg0_tmp.c_str();
        std::string arg1_tmp;
        ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, "plugin.ProtocolAnalytics:logError");
        arg1 = arg1_tmp.c_str();
        if (!ok) {
...
int lua_pluginx_protocols_ProtocolAnalytics_logEvent(lua_State* tolua_S) {
    ...
    if (argc == 1) {
        const char* arg0;
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "plugin.ProtocolAnalytics:logEvent");
        arg0 = arg0_tmp.c_str();
        if (!ok) {
    ...
    if (argc == 2) {
        ...
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "plugin.ProtocolAnalytics:logEvent");
        arg0 = arg0_tmp.c_str();
        ok &= luaval_to_object<std::map<std::basic_string<char>, std::basic_string<char>, std::less<std::basic_string<char>>, std::allocator<std::pair<const std::basic_string<char>, std::basic_string<char>>>>>(
            tolua_S, 3, "std::map<std::basic_string<char>, std::basic_string<char>, std::less<std::basic_string<char> >, std::allocator<std::pair<const std::basic_string<char>, std::basic_string<char> > > >*", &arg1);
        if (!ok) {
            tolua_error(tolua_S, "invalid arguments in function 'lua_pluginx_protocols_ProtocolAnalytics_logEvent'", nullptr);
            return 0;
        }
...
int lua_pluginx_protocols_ProtocolAnalytics_startSession(lua_State* tolua_S) {
    ...
    if (argc == 1) {
        const char* arg0;
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "plugin.ProtocolAnalytics:startSession");
        arg0 = arg0_tmp.c_str();
        if (!ok) {
...
int lua_pluginx_protocols_ProtocolAnalytics_logTimedEventEnd(lua_State* tolua_S) {
    ...
    if (argc == 1) {
        const char* arg0;
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "plugin.ProtocolAnalytics:logTimedEventEnd");
        arg0 = arg0_tmp.c_str();
        if (!ok) {
...
int lua_pluginx_protocols_ProtocolIAP_onPayResult(lua_State* tolua_S) {
    ...
    if (argc == 2) {
        ...
        std::string arg1_tmp;
        ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, "plugin.ProtocolIAP:onPayResult");
        arg1 = arg1_tmp.c_str();
        if (!ok) {
...
int lua_pluginx_protocols_ProtocolShare_onShareResult(lua_State* tolua_S) {
    ...
    if (argc == 2) {
        ...
        std::string arg1_tmp;
        ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, "plugin.ProtocolShare:onShareResult");
        arg1 = arg1_tmp.c_str();
        if (!ok) {
...
int lua_pluginx_protocols_ProtocolSocial_showLeaderboard(lua_State* tolua_S) {
    ...
    if (argc == 1) {
        const char* arg0;
        std::string arg0_tmp;
        ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "plugin.ProtocolSocial:showLeaderboard");
        arg0 = arg0_tmp.c_str();
        if (!ok) {
