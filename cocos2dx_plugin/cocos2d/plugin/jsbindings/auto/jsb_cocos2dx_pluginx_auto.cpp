...
static bool empty_constructor(JSContext *cx, uint32_t argc, jsval *vp) { return false; }
...
void js_register_pluginx_protocols_PluginProtocol(JSContext *cx, JS::HandleObject global) {
    ...
    static JSPropertySpec properties[] = {JS_PSG("__nativeObj", js_is_native_obj, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_PS_END};
    static JSFunctionSpec funcs[] = {
        JS_FN("getPluginName", js_pluginx_protocols_PluginProtocol_getPluginName, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FN("getPluginVersion", js_pluginx_protocols_PluginProtocol_getPluginVersion, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("getSDKVersion", js_pluginx_protocols_PluginProtocol_getSDKVersion, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FN("setDebugMode", js_pluginx_protocols_PluginProtocol_setDebugMode, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FS_END};
    JSFunctionSpec *st_funcs = NULL;
    jsb_cocos2d_plugin_PluginProtocol_prototype = JS_InitClass(cx, global, JS::NullPtr(),                                                               // parent proto
                                                               jsb_cocos2d_plugin_PluginProtocol_class, empty_constructor, 0, properties, funcs, NULL,  // no static properties
                                                               st_funcs);
...
void js_register_pluginx_protocols_PluginManager(JSContext *cx, JS::HandleObject global) {
    ...
    static JSPropertySpec properties[] = {JS_PSG("__nativeObj", js_is_native_obj, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_PS_END};
    static JSFunctionSpec funcs[] = {JS_FN("unloadPlugin", js_pluginx_protocols_PluginManager_unloadPlugin, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     JS_FN("loadPlugin", js_pluginx_protocols_PluginManager_loadPlugin, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    static JSFunctionSpec st_funcs[] = {JS_FN("end", js_pluginx_protocols_PluginManager_end, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FN("getInstance", js_pluginx_protocols_PluginManager_getInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FS_END};
    jsb_cocos2d_plugin_PluginManager_prototype = JS_InitClass(cx, global, JS::NullPtr(),                                                              // parent proto
                                                              jsb_cocos2d_plugin_PluginManager_class, empty_constructor, 0, properties, funcs, NULL,  // no static properties
                                                              st_funcs);
    // make the class enumerable in the registered namespace
    //  bool found;
    // FIXME: Removed in Firefox v27
...
void js_register_pluginx_protocols_ProtocolAnalytics(JSContext *cx, JS::HandleObject global) {
    ...
    static JSPropertySpec properties[] = {JS_PSG("__nativeObj", js_is_native_obj, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_PS_END};
    static JSFunctionSpec funcs[] = {JS_FN("logTimedEventBegin", js_pluginx_protocols_ProtocolAnalytics_logTimedEventBegin, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     ...
                                     JS_FS_END};
    JSFunctionSpec *st_funcs = NULL;
    jsb_cocos2d_plugin_ProtocolAnalytics_prototype =
        JS_InitClass(cx, global, JS::RootedObject(cx, jsb_cocos2d_plugin_PluginProtocol_prototype), jsb_cocos2d_plugin_ProtocolAnalytics_class, empty_constructor, 0, properties, funcs, NULL,  // no static properties
                     st_funcs);
    // make the class enumerable in the registered namespace
    //  bool found;
    // FIXME: Removed in Firefox v27
...
void js_register_pluginx_protocols_ProtocolIAP(JSContext *cx, JS::HandleObject global) {
    ...
    static JSPropertySpec properties[] = {JS_PSG("__nativeObj", js_is_native_obj, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_PS_END};
    static JSFunctionSpec funcs[] = {
        JS_FN("onPayResult", js_pluginx_protocols_ProtocolIAP_onPayResult, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),                 JS_FN("getCallback", js_pluginx_protocols_ProtocolIAP_getCallback, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("configDeveloperInfo", js_pluginx_protocols_ProtocolIAP_configDeveloperInfo, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    JSFunctionSpec *st_funcs = NULL;
    jsb_cocos2d_plugin_ProtocolIAP_prototype = JS_InitClass(cx, global, JS::RootedObject(cx, jsb_cocos2d_plugin_PluginProtocol_prototype), jsb_cocos2d_plugin_ProtocolIAP_class, empty_constructor, 0, properties, funcs, NULL,  // no static properties
                                                            st_funcs);
    // make the class enumerable in the registered namespace
    //  bool found;
    // FIXME: Removed in Firefox v27
...
void js_register_pluginx_protocols_ProtocolAds(JSContext *cx, JS::HandleObject global) {
    ...
    static JSPropertySpec properties[] = {JS_PSG("__nativeObj", js_is_native_obj, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_PS_END};
    static JSFunctionSpec funcs[] = {
        JS_FN("showAds", js_pluginx_protocols_ProtocolAds_showAds, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),         JS_FN("hideAds", js_pluginx_protocols_ProtocolAds_hideAds, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("queryPoints", js_pluginx_protocols_ProtocolAds_queryPoints, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FN("getCallback", js_pluginx_protocols_ProtocolAds_getCallback, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("spendPoints", js_pluginx_protocols_ProtocolAds_spendPoints, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FN("configDeveloperInfo", js_pluginx_protocols_ProtocolAds_configDeveloperInfo, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FS_END};
    JSFunctionSpec *st_funcs = NULL;
    jsb_cocos2d_plugin_ProtocolAds_prototype = JS_InitClass(cx, global, JS::RootedObject(cx, jsb_cocos2d_plugin_PluginProtocol_prototype), jsb_cocos2d_plugin_ProtocolAds_class, empty_constructor, 0, properties, funcs, NULL,  // no static properties
                                                            st_funcs);
    // make the class enumerable in the registered namespace
    //  bool found;
    // FIXME: Removed in Firefox v27
...
void js_register_pluginx_protocols_ProtocolShare(JSContext *cx, JS::HandleObject global) {
    ...
    static JSPropertySpec properties[] = {JS_PSG("__nativeObj", js_is_native_obj, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_PS_END};
    static JSFunctionSpec funcs[] = {
        JS_FN("onShareResult", js_pluginx_protocols_ProtocolShare_onShareResult, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),             JS_FN("getCallback", js_pluginx_protocols_ProtocolShare_getCallback, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("configDeveloperInfo", js_pluginx_protocols_ProtocolShare_configDeveloperInfo, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    JSFunctionSpec *st_funcs = NULL;
    jsb_cocos2d_plugin_ProtocolShare_prototype =
        JS_InitClass(cx, global, JS::RootedObject(cx, jsb_cocos2d_plugin_PluginProtocol_prototype), jsb_cocos2d_plugin_ProtocolShare_class, empty_constructor, 0, properties, funcs, NULL,  // no static properties
                     st_funcs);
    // make the class enumerable in the registered namespace
    //  bool found;
    // FIXME: Removed in Firefox v27
...
void js_register_pluginx_protocols_ProtocolSocial(JSContext *cx, JS::HandleObject global) {
    ...
    static JSPropertySpec properties[] = {JS_PSG("__nativeObj", js_is_native_obj, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_PS_END};
    static JSFunctionSpec funcs[] = {JS_FN("showLeaderboard", js_pluginx_protocols_ProtocolSocial_showLeaderboard, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     ...
                                     JS_FS_END};
    JSFunctionSpec *st_funcs = NULL;
    jsb_cocos2d_plugin_ProtocolSocial_prototype =
        JS_InitClass(cx, global, JS::RootedObject(cx, jsb_cocos2d_plugin_PluginProtocol_prototype), jsb_cocos2d_plugin_ProtocolSocial_class, empty_constructor, 0, properties, funcs, NULL,  // no static properties
                     st_funcs);
    // make the class enumerable in the registered namespace
    //  bool found;
    // FIXME: Removed in Firefox v27
...
void js_register_pluginx_protocols_ProtocolUser(JSContext *cx, JS::HandleObject global) {
    ...
    static JSPropertySpec properties[] = {JS_PSG("__nativeObj", js_is_native_obj, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_PS_END};
    static JSFunctionSpec funcs[] = {
        JS_FN("getCallback", js_pluginx_protocols_ProtocolUser_getCallback, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),       JS_FN("configDeveloperInfo", js_pluginx_protocols_ProtocolUser_configDeveloperInfo, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("isLoggedIn", js_pluginx_protocols_ProtocolUser_isLoggedIn, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),         JS_FN("getSessionID", js_pluginx_protocols_ProtocolUser_getSessionID, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("getAccessToken", js_pluginx_protocols_ProtocolUser_getAccessToken, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    JSFunctionSpec *st_funcs = NULL;
    jsb_cocos2d_plugin_ProtocolUser_prototype = JS_InitClass(cx, global, JS::RootedObject(cx, jsb_cocos2d_plugin_PluginProtocol_prototype), jsb_cocos2d_plugin_ProtocolUser_class, empty_constructor, 0, properties, funcs, NULL,  // no static properties
                                                             st_funcs);
    // make the class enumerable in the registered namespace
    //  bool found;
    // FIXME: Removed in Firefox v27
...
void js_register_pluginx_protocols_AgentManager(JSContext *cx, JS::HandleObject global) {
    ...
    static JSPropertySpec properties[] = {JS_PSG("__nativeObj", js_is_native_obj, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_PS_END};
    static JSFunctionSpec funcs[] = {
        JS_FN("getSocialPlugin", js_pluginx_protocols_AgentManager_getSocialPlugin, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),       JS_FN("getAdsPlugin", js_pluginx_protocols_AgentManager_getAdsPlugin, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("purge", js_pluginx_protocols_AgentManager_purge, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),                           JS_FN("getUserPlugin", js_pluginx_protocols_AgentManager_getUserPlugin, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("getIAPPlugin", js_pluginx_protocols_AgentManager_getIAPPlugin, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),             JS_FN("getSharePlugin", js_pluginx_protocols_AgentManager_getSharePlugin, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("getAnalyticsPlugin", js_pluginx_protocols_AgentManager_getAnalyticsPlugin, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    static JSFunctionSpec st_funcs[] = {JS_FN("destroyInstance", js_pluginx_protocols_AgentManager_destroyInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FN("getInstance", js_pluginx_protocols_AgentManager_getInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    jsb_cocos2d_plugin_AgentManager_prototype = JS_InitClass(cx, global, JS::NullPtr(),                                                             // parent proto
                                                             jsb_cocos2d_plugin_AgentManager_class, empty_constructor, 0, properties, funcs, NULL,  // no static properties
                                                             st_funcs);
    // make the class enumerable in the registered namespace
    //  bool found;
    // FIXME: Removed in Firefox v27
...
void js_register_pluginx_protocols_FacebookAgent(JSContext *cx, JS::HandleObject global) {
    ...
    static JSPropertySpec properties[] = {JS_PSG("__nativeObj", js_is_native_obj, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_PS_END};
    static JSFunctionSpec funcs[] = {JS_FN("activateApp", js_pluginx_protocols_FacebookAgent_activateApp, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                     ...
                                     JS_FS_END};
    static JSFunctionSpec st_funcs[] = {JS_FN("destroyInstance", js_pluginx_protocols_FacebookAgent_destroyInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
                                        JS_FN("getInstanceJs", js_pluginx_protocols_FacebookAgent_getInstanceJs, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE), JS_FS_END};
    jsb_cocos2d_plugin_FacebookAgent_prototype = JS_InitClass(cx, global, JS::NullPtr(),                                                              // parent proto
                                                              jsb_cocos2d_plugin_FacebookAgent_class, empty_constructor, 0, properties, funcs, NULL,  // no static properties
                                                              st_funcs);
    // make the class enumerable in the registered namespace
    //  bool found;
    // FIXME: Removed in Firefox v27
