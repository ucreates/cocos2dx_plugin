...
void js_register_pluginx_protocols_PluginParam(JSContext *cx, JS::HandleObject global) {
    ...
    jsb_PluginParam_prototype = JS_InitClass(cx, global, JS::NullPtr(),                                               // parent proto
                                             jsb_PluginParam_class, js_pluginx_protocols_PluginParam_constructor, 0,  // constructor
