...
void FacebookAgent::login(FBCallback cb) { agentManager->getUserPlugin()->login(cb); }
...
void FacebookAgent::logout() { agentManager->getUserPlugin()->logout(); }
bool FacebookAgent::isLoggedIn() { return agentManager->getUserPlugin()->isLoggedIn(); }
std::string FacebookAgent::getAccessToken() { return agentManager->getUserPlugin()->callStringFuncWithParam("getAccessToken", NULL); }
void FacebookAgent::share(FBInfo& info, FBCallback cb) { agentManager->getSharePlugin()->share(info, cb); }
std::string FacebookAgent::getPermissionList() { return agentManager->getUserPlugin()->callStringFuncWithParam("getPermissionList", NULL); }
std::string FacebookAgent::getUserID() { return agentManager->getUserPlugin()->callStringFuncWithParam("getUserID", NULL); }
...
FacebookAgent::FBCallback FacebookAgent::getRequestCallback(int index) { return requestCallbacks[index]; }
void FacebookAgent::activateApp() { agentManager->getUserPlugin()->callFuncWithParam("activateApp", NULL); }
...
std::string FacebookAgent::getSDKVersion() { return agentManager->getUserPlugin()->callStringFuncWithParam("getSDKVersion", NULL); }
