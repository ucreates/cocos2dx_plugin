 ...
 */
typedef void (^FBRequestHandler)(FBRequestConnection *connection, id result, NSError *error);
/*!
 @protocol
 @abstract
 ...
 */
- (void)requestConnectionWillBeginLoading:(FBRequestConnection *)connection fromCache:(BOOL)isCached;
/*!
 @method
 @abstract
 ...
 */
- (void)requestConnection:(FBRequestConnection *)connection willRetryWithRequestConnection:(FBRequestConnection *)retryConnection;
/*!
 @method
 @abstract
 ...
 */
- (void)addRequest:(FBRequest *)request completionHandler:(FBRequestHandler)handler batchParameters:(NSDictionary *)batchParameters;
/*!
...
/*!
 ...
 @param handler The handler block to call when the request completes with a success, error, or cancel action.
 */
+ (FBRequestConnection *)startForCustomAudienceThirdPartyID:(FBSession *)session completionHandler:(FBRequestHandler)handler;
/*!
 @method
 @abstract
...
/*!
 ...
 @param handler          The handler block to call when the request completes with a success, error, or cancel action.
 */
+ (FBRequestConnection *)startForDeleteObject:(id)object completionHandler:(FBRequestHandler)handler;
/*!
 @method
 @abstract
...
/*!
 ...
 @param handler          The handler block to call when the request completes with a success, error, or cancel action.
 */
+ (FBRequestConnection *)startForPostOpenGraphObject:(id<FBOpenGraphObject>)object completionHandler:(FBRequestHandler)handler;
/*!
 @method
 @abstract
 Creates an `FBRequest` for creating a user owned Open Graph object, instantiate a
...
/*!
 ...
 @param handler          The handler block to call when the request completes with a success, error, or cancel action.
 */
+ (FBRequestConnection *)startForUpdateOpenGraphObject:(id<FBOpenGraphObject>)object completionHandler:(FBRequestHandler)handler;
/*!
 @method
 @abstract
 Creates an `FBRequest` for updating a user owned Open Graph object, instantiate a
 ...
 */
+ (FBRequestConnection *)startForUploadStagingResourceWithImage:(UIImage *)image completionHandler:(FBRequestHandler)handler;
@end
