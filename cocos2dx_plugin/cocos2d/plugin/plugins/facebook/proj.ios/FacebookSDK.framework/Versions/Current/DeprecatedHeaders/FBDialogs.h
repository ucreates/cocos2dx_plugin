 ...
 */
+ (BOOL)presentOSIntegratedShareDialogModallyFrom:(UIViewController *)viewController initialText:(NSString *)initialText image:(UIImage *)image url:(NSURL *)url handler:(FBOSIntegratedShareDialogHandler)handler;
/*!
 @abstract
 Presents a dialog that allows the user to share a status update that may include
 text, images, or URLs. This dialog is only available on iOS 6.0 and above. The
 ...
 will still be called, with an error indicating the reason the dialog was not displayed)
 */
+ (BOOL)presentOSIntegratedShareDialogModallyFrom:(UIViewController *)viewController initialText:(NSString *)initialText images:(NSArray *)images urls:(NSArray *)urls handler:(FBOSIntegratedShareDialogHandler)handler;
/*!
 @abstract
 Presents a dialog that allows the user to share a status update that may include
 ...
 will still be called, with an error indicating the reason the dialog was not displayed)
 */
+ (BOOL)presentOSIntegratedShareDialogModallyFrom:(UIViewController *)viewController session:(FBSession *)session initialText:(NSString *)initialText images:(NSArray *)images urls:(NSArray *)urls handler:(FBOSIntegratedShareDialogHandler)handler;
/*!
 ...
 */
+ (FBAppCall *)presentShareDialogWithParams:(FBLinkShareParams *)params clientState:(NSDictionary *)clientState handler:(FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
 ...
 canPresentShareDialogWithParams method is also returning YES for the same params.
 */
+ (FBAppCall *)presentShareDialogWithLink:(NSURL *)link handler:(FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
 Presents a dialog in the Facebook application that allows the user to share the
 supplied link. No session is required, and the app does not need to be authorized
 ...
 canPresentShareDialogWithParams method is also returning YES for the same params.
 */
+ (FBAppCall *)presentShareDialogWithLink:(NSURL *)link name:(NSString *)name handler:(FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
 Presents a dialog in the Facebook application that allows the user to share the
 supplied link. No session is required, and the app does not need to be authorized
 ...
 */
+ (FBAppCall *)presentShareDialogWithPhotoParams:(FBPhotoParams *)params clientState:(NSDictionary *)clientState handler:(FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
 Presents a dialog in the Facebook application that allows the user to share the
 supplied photo(s). No session is required, and the app does not need to be authorized
 ...
 canPresentShareDialogWithPhotoParams method is also returning YES for the same params.
 */
+ (FBAppCall *)presentShareDialogWithPhotos:(NSArray *)photos handler:(FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
 Presents a dialog in the Facebook application that allows the user to share the
 supplied photo(s). No session is required, and the app does not need to be authorized
 ...
 canPresentShareDialogWithPhotoParams method is also returning YES for the same params.
 */
+ (FBAppCall *)presentShareDialogWithPhotos:(NSArray *)photos clientState:(NSDictionary *)clientState handler:(FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
 ...
 */
+ (FBAppCall *)presentShareDialogWithOpenGraphActionParams:(FBOpenGraphActionParams *)params clientState:(NSDictionary *)clientState handler:(FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
 ...
 @discussion A non-nil FBAppCall object is only returned if the corresponding
 canPresentShareDialogWithOpenGraphActionParams method is also returning YES for the same params.
 */ +(FBAppCall *)presentShareDialogWithOpenGraphAction : (id<FBOpenGraphAction>)action actionType : (NSString *)actionType previewPropertyName : (NSString *)previewPropertyName handler : (FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
 Presents a dialog in the Facebook application that allows the user to publish the
 supplied Open Graph action. No session is required, and the app does not need to be
 ...
 */
+ (FBAppCall *)presentMessageDialogWithOpenGraphActionParams:(FBOpenGraphActionParams *)params clientState:(NSDictionary *)clientState handler:(FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
...
/*!
 ...
 `canPresentMessageDialogWithPhotos` method is also returning YES.
*/
+ (FBAppCall *)presentMessageDialogWithPhotos:(NSArray *)photos clientState:(NSDictionary *)clientState handler:(FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
 ...
 */
+ (FBAppCall *)presentMessageDialogWithParams:(FBLinkShareParams *)params clientState:(NSDictionary *)clientState handler:(FBDialogAppCallCompletionHandler)handler;
/*!
 @abstract
