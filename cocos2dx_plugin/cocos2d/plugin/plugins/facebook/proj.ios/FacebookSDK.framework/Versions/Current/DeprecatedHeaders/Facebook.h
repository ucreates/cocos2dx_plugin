...
- (instancetype)initWithAppId:(NSString *)appId andDelegate:(id<FBSessionDelegate>)delegate;
- (instancetype)initWithAppId:(NSString *)appId urlSchemeSuffix:(NSString *)urlSchemeSuffix andDelegate:(id<FBSessionDelegate>)delegate;
