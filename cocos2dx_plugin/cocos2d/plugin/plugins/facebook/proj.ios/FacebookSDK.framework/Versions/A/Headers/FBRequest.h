 ...
 */
- (instancetype)initWithSession:(FBSession *)session graphPath:(NSString *)graphPath;
/*!
 @method
 @abstract
 ...
 */
- (instancetype)initWithSession:(FBSession *)session graphPath:(NSString *)graphPath parameters:(NSDictionary *)parameters HTTPMethod:(NSString *)HTTPMethod;
/*!
 @method
 @abstract
 ...
 */
- (instancetype)initForPostWithSession:(FBSession *)session graphPath:(NSString *)graphPath graphObject:(id<FBGraphObject>)graphObject;
/*!
 @abstract
 ...
 */
+ (FBRequest *)requestForPostOpenGraphObjectWithType:(NSString *)type title:(NSString *)title image:(id)image url:(id)url description:(NSString *)description objectProperties:(NSDictionary *)objectProperties;
/*!
 @method
 @abstract
 ...
 */
+ (FBRequest *)requestForUpdateOpenGraphObjectWithId:(id)objectId title:(NSString *)title image:(id)image url:(id)url description:(NSString *)description objectProperties:(NSDictionary *)objectProperties;
/*!
 @method
 @abstract
