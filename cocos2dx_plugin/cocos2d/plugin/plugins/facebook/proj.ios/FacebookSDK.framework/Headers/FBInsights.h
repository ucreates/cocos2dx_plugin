 ...
 */
__attribute__((deprecated("use FBAppEventsFlushBehavior instead"))) typedef NS_ENUM(NSUInteger, FBInsightsFlushBehavior) {FBInsightsFlushBehaviorAuto __attribute__((deprecated("use FBAppEventsFlushBehaviorAuto instead"))),
 ...
 */
__attribute__((deprecated("Use the FBAppEvents class instead"))) @interface FBInsights : NSObject + (NSString *)appVersion __attribute__((deprecated));
