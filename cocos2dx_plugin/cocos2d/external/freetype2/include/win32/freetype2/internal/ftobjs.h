...
#define FT_DEFINE_CMAP_CLASS(class_, size_, init_, done_, char_index_, char_next_, char_var_index_, char_var_default_, variant_list_, charvariant_list_, variantchar_list_) \
    FT_CALLBACK_TABLE_DEF const FT_CMap_ClassRec class_ = {size_, init_, done_, char_index_, char_next_, char_var_index_, char_var_default_, variant_list_, charvariant_list_, variantchar_list_};
...
/* */
#define FT_REQUEST_WIDTH(req) ((req)->horiResolution ? (FT_Pos)((req)->width*(req)->horiResolution + 36) / 72 : (req)->width)
#define FT_REQUEST_HEIGHT(req) ((req)->vertResolution ? (FT_Pos)((req)->height*(req)->vertResolution + 36) / 72 : (req)->height)
...
/*                                                                       */
#ifndef FT_CONFIG_OPTION_PIC
#define FT_DEFINE_GLYPH(class_, size_, format_, init_, done_, copy_, transform_, bbox_, prepare_) FT_CALLBACK_TABLE_DEF const FT_Glyph_Class class_ = {size_, format_, init_, done_, copy_, transform_, bbox_, prepare_};
#else /* FT_CONFIG_OPTION_PIC */
...
#define FT_DEFINE_RENDERER(class_, flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_, glyph_format_, render_glyph_, transform_glyph_, get_glyph_cbox_, set_mode_, raster_class_) \
    FT_CALLBACK_TABLE_DEF const FT_Renderer_Class                                                                                                                                                                  \
        class_ = {FT_DEFINE_ROOT_MODULE(flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_) glyph_format_, render_glyph_, transform_glyph_, get_glyph_cbox_, set_mode_, raster_class_};
#else /* FT_CONFIG_OPTION_PIC */
    ...
    FT_Error FT_Create_Class_##class_(FT_Library library, FT_Module_Class** output_class) {                                                                                                                        \
        ...
        if (error) {                                                                                                                                                                                               \
            ...
            return error;                                                                                                                                                                                          \
                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                   \
        FT_DEFINE_ROOT_MODULE(flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_) clazz->glyph_format = glyph_format_;                                                            \
                                                                                                                                                                                                                   \
...
/*                                                                       */
#ifndef FT_CONFIG_OPTION_PIC
#define FT_DECLARE_MODULE(class_) FT_CALLBACK_TABLE const FT_Module_Class class_;
#define FT_DEFINE_ROOT_MODULE(flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_) \
    { flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_, }                       \
    ,
#define FT_DEFINE_MODULE(class_, flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_) \
    FT_CALLBACK_TABLE_DEF const FT_Module_Class class_ = {flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_, };
#else /* FT_CONFIG_OPTION_PIC */
