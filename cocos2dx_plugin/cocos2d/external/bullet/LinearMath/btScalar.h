...
#define BT_DECLARE_ALIGNED_ALLOCATOR()                                                                                                                                                                                            \
    ...
    SIMD_FORCE_INLINE void *operator new [](size_t sizeInBytes) { return btAlignedAlloc(sizeInBytes, 16); } SIMD_FORCE_INLINE void operator delete [](void *ptr) { btAlignedFree(ptr); } SIMD_FORCE_INLINE void *operator new []( \
        size_t, void *ptr) { return ptr; } SIMD_FORCE_INLINE void operator delete [](void *, void *) {}
...
SIMD_FORCE_INLINE unsigned btSwapEndian(unsigned val) { return (((val & 0xff000000) >> 24) | ((val & 0x00ff0000) >> 8) | ((val & 0x0000ff00) << 8) | ((val & 0x000000ff) << 24)); }
SIMD_FORCE_INLINE unsigned short btSwapEndian(unsigned short val) { return static_cast<unsigned short>(((val & 0xff00) >> 8) | ((val & 0x00ff) << 8)); }
SIMD_FORCE_INLINE unsigned btSwapEndian(int val) { return btSwapEndian((unsigned)val); }
SIMD_FORCE_INLINE unsigned short btSwapEndian(short val) { return btSwapEndian((unsigned short)val); }
