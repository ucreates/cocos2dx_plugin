...
int hasvert(const int3 &t, int v) { return (t[0] == v || t[1] == v || t[2] == v); }
...
bool HullLibrary::CleanupVertices(unsigned int svcount, const btVector3 *svertices, unsigned int stride, unsigned int &vcount,  // output number of vertices
