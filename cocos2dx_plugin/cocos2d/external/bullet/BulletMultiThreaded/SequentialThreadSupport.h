...
class SequentialThreadSupport : public btThreadSupportInterface {
   ...
   public:
    struct SequentialThreadConstructionInfo {
        SequentialThreadConstructionInfo(const char* uniqueName, SequentialThreadFunc userThreadFunc, SequentiallsMemorySetupFunc lsMemoryFunc) : m_uniqueName(uniqueName), m_userThreadFunc(userThreadFunc), m_lsMemoryFunc(lsMemoryFunc) {}
    ...
    virtual int getNumTasks() const { return 1; }
