...
#define cellDmaLargeGet(ls, ea, size, tag, tid, rid)                                                                                                                                                            \
    if ((((uintsize)ls % 16) != ((uintsize)ea % 16)) || ((((uintsize)ea % 16) || ((uintsize)ls % 16)) && ((((uintsize)ls % 16) != ((uintsize)size % 16)) || (((uintsize)ea % 16) != ((uintsize)size % 16)))) || \
        (((uintsize)size % 16) && ((uintsize)size != 1) && ((uintsize)size != 2) && ((uintsize)size != 4) && ((uintsize)size != 8)) || (size >= 16384) || !(uintsize)ls || !(uintsize)ea) {                     \
        ...
        dUASSERT(ea != 0, "Nullpointer EA: ");                                                                                                                                                                  \
        dUASSERT(ls != 0, "Nullpointer LS: ");                                                                                                                                                                  \
...
#define cellDmaSmallGet(ls, ea, size, tag, tid, rid)                                                                                                                                                            \
    ...
    mfc_get(ls, ea, size, tag, tid, rid)
#define cellDmaWaitTagStatusAll(ignore) \
    mfc_write_tag_mask(ignore);         \
