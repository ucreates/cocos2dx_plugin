...
class CLFunctions {
   ...
   public:
    CLFunctions(cl_command_queue cqCommandQue, cl_context cxMainContext) : m_cqCommandQue(cqCommandQue), m_cxMainContext(cxMainContext), m_kernelCompilationFailures(0) {}
    int getKernelCompilationFailures() const { return m_kernelCompilationFailures; }
    /**
    ...
    void clearKernelCompilationFailures() { m_kernelCompilationFailures = 0; }
};
/**
...
class btOpenCLAcceleratedSoftBodyInterface {
   ...
   public:
    btOpenCLAcceleratedSoftBodyInterface(btSoftBody *softBody) : m_softBody(softBody) {
        m_numVertices = 0;
        m_maxVertices = 0;
        m_numTriangles = 0;
        m_maxTriangles = 0;
    ...
    int getMaxVertices() { return m_maxVertices; }
    int getMaxTriangles() { return m_maxTriangles; }
    int getFirstVertex() { return m_firstVertex; }
    int getFirstTriangle() { return m_firstTriangle; }
    /**
...
class btOpenCLSoftBodySolver : public btSoftBodySolver {
   ...
   public:
    ...
    virtual SolverTypes getSolverType() const { return CL_SOLVER; }
    ...
    virtual void setDefaultWorkgroupSize(size_t workGroupSize) { m_defaultWorkGroupSize = workGroupSize; }
    virtual size_t getDefaultWorkGroupSize() const { return m_defaultWorkGroupSize; }
