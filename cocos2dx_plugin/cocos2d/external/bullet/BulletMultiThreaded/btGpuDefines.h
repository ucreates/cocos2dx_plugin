...
inline int3 operator+(int3 a, int3 b) { return bt3dGrid_make_int3(a.x + b.x, a.y + b.y, a.z + b.z); }
...
inline float4 operator*(float fact, float4& a) { return (a * fact); }
...
static inline float bt3dGrid_dot(float3& a, float3& b) { return a.x * b.x + a.y * b.y + a.z * b.z; }
#define BT_GPU_dot(a, b) bt3dGrid_dot(a, b)
static inline float bt3dGrid_dot4(float4& a, float4& b) { return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w; }
