...
SpuSampleTaskProcess::SpuSampleTaskProcess(btThreadSupportInterface* threadInterface, int maxNumOutstandingTasks) : m_threadInterface(threadInterface), m_maxNumOutstandingTasks(maxNumOutstandingTasks) {
...
SpuSampleTaskProcess::~SpuSampleTaskProcess() { m_threadInterface->stopSPU(); }
