...
ATTRIBUTE_ALIGNED16(class) SpuContactManifoldCollisionAlgorithm : public btCollisionAlgorithm {
   ...
   public:
    ...
    btPersistentManifold* getContactManifoldPtr() { return m_manifoldPtr; }
    const btCollisionObject* getCollisionObject0() { return m_collisionObject0; }
    const btCollisionObject* getCollisionObject1() { return m_collisionObject1; }
    int getShapeType0() const { return m_shapeType0; }
    int getShapeType1() const { return m_shapeType1; }
    float getCollisionMargin0() const { return m_collisionMargin0; }
    float getCollisionMargin1() const { return m_collisionMargin1; }
    const btVector3& getShapeDimensions0() const { return m_shapeDimensions0; }
    const btVector3& getShapeDimensions1() const { return m_shapeDimensions1; }
