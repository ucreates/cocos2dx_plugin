...
struct btSparseSdf {
    ...
    btScalar Evaluate(const btVector3& x, const btCollisionShape* shape, btVector3& normal, btScalar margin) {
        ...
        const btScalar d[] = {c->d[o[0] + 0][o[1] + 0][o[2] + 0], c->d[o[0] + 1][o[1] + 0][o[2] + 0], c->d[o[0] + 1][o[1] + 1][o[2] + 0], c->d[o[0] + 0][o[1] + 1][o[2] + 0],
                              c->d[o[0] + 0][o[1] + 0][o[2] + 1], c->d[o[0] + 1][o[1] + 0][o[2] + 1], c->d[o[0] + 1][o[1] + 1][o[2] + 1], c->d[o[0] + 0][o[1] + 1][o[2] + 1]};
/* Normal    */
#if 1
...
#endif
        /* Distance    */
        const btScalar d0 = Lerp(Lerp(d[0], d[1], ix.f), Lerp(d[3], d[2], ix.f), iy.f);
        const btScalar d1 = Lerp(Lerp(d[4], d[5], ix.f), Lerp(d[7], d[6], ix.f), iy.f);
    ...
    //
    static inline btScalar Lerp(btScalar a, btScalar b, btScalar t) { return (a + (b - a) * t); }
    //
