...
class btConeShapeX : public btConeShape {
   public:
    ...
    virtual btVector3 getAnisotropicRollingFrictionDirection() const { return btVector3(1, 0, 0); }
    // debugging
...
class btConeShapeZ : public btConeShape {
   public:
    ...
    virtual btVector3 getAnisotropicRollingFrictionDirection() const { return btVector3(0, 0, 1); }
    // debugging
...
SIMD_FORCE_INLINE int btConeShape::calculateSerializeBufferSize() const { return sizeof(btConeShapeData); }
/// fills the dataBuffer and returns the struct name (and 0 on failure)
