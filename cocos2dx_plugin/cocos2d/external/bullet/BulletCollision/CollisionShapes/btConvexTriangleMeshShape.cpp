...
class LocalSupportVertexCallback : public btInternalTriangleIndexCallback {
   ...
   public:
    ...
    LocalSupportVertexCallback(const btVector3& supportVecLocal) : m_supportVertexLocal(btScalar(0.), btScalar(0.), btScalar(0.)), m_maxDot(btScalar(-BT_LARGE_FLOAT)), m_supportVecLocal(supportVecLocal) {}
...
void btConvexTriangleMeshShape::getEdge(int, btVector3&, btVector3&) const { btAssert(0); }
void btConvexTriangleMeshShape::getVertex(int, btVector3&) const { btAssert(0); }
int btConvexTriangleMeshShape::getNumPlanes() const { return 0; }
void btConvexTriangleMeshShape::getPlane(btVector3&, btVector3&, int) const { btAssert(0); }
// not yet
...
const btVector3& btConvexTriangleMeshShape::getLocalScaling() const { return m_stridingMesh->getScaling(); }
