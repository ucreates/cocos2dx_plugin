...
ATTRIBUTE_ALIGNED16(class) btScaledBvhTriangleMeshShape : public btConcaveShape {
   ...
   public:
    ...
    const btBvhTriangleMeshShape* getChildShape() const { return m_bvhTriMeshShape; }
    // debugging
...
SIMD_FORCE_INLINE int btScaledBvhTriangleMeshShape::calculateSerializeBufferSize() const { return sizeof(btScaledTriangleMeshShapeData); }
/// fills the dataBuffer and returns the struct name (and 0 on failure)
