...
btPolyhedralConvexShape::btPolyhedralConvexShape() : btConvexInternalShape(), m_polyhedron(0) {}
...
bool btPolyhedralConvexShape::initializePolyhedralFeatures(int shiftVerticesByMargin) {
    ...
    while (todoFaces.size()) {
        ...
        if (coplanarFaceGroup.size() > 1) {
            ...
            btFace combinedFace;
            for (int i = 0; i < 4; i++) combinedFace.m_plane[i] = tmpFaces[coplanarFaceGroup[0]].m_plane[i];
...
btPolyhedralConvexAabbCachingShape::btPolyhedralConvexAabbCachingShape() : btPolyhedralConvexShape(), m_localAabbMin(1, 1, 1), m_localAabbMax(-1, -1, -1), m_isLocalAabbValid(false) {}
