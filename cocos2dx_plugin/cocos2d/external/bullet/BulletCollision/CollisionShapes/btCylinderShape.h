...
class btCylinderShapeX : public btCylinderShape {
   public:
    ...
    virtual btScalar getRadius() const { return getHalfExtentsWithMargin().getY(); }
};
...
SIMD_FORCE_INLINE int btCylinderShape::calculateSerializeBufferSize() const { return sizeof(btCylinderShapeData); }
/// fills the dataBuffer and returns the struct name (and 0 on failure)
