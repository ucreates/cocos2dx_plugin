...
ATTRIBUTE_ALIGNED16(class) btTriangleShape : public btPolyhedralConvexShape {
   public:
    ...
    virtual void getVertex(int index, btVector3 & vert) const { vert = m_vertices1[index]; }
    ...
    btTriangleShape() : btPolyhedralConvexShape() { m_shapeType = TRIANGLE_SHAPE_PROXYTYPE; }
    ...
    virtual void getPlane(btVector3 & planeNormal, btVector3 & planeSupport, int i) const { getPlaneEquation(i, planeNormal, planeSupport); }
