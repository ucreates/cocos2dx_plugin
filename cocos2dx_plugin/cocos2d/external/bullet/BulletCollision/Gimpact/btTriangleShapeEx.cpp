...
void GIM_TRIANGLE_CONTACT::merge_points(const btVector4& plane, btScalar margin, const btVector3* points, int point_count) {
    m_point_count = 0;
...
int btPrimitiveTriangle::clip_triangle(btPrimitiveTriangle& other, btVector3* clipped_points) {
    ...
    int clipped_count = bt_plane_clip_triangle(edgeplane, other.m_vertices[0], other.m_vertices[1], other.m_vertices[2], temp_points);
    ...
    clipped_count = bt_plane_clip_polygon(edgeplane, temp_points1, clipped_count, clipped_points);
