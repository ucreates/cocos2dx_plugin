...
struct MyCallback : public btTriangleRaycastCallback {
    ...
    MyCallback(const btVector3& from, const btVector3& to, int ignorePart, int ignoreTriangleIndex) : btTriangleRaycastCallback(from, to), m_ignorePart(ignorePart), m_ignoreTriangleIndex(ignoreTriangleIndex) {}
...
struct MyInternalTriangleIndexCallback : public btInternalTriangleIndexCallback {
    ...
    btScalar m_depth;
    MyInternalTriangleIndexCallback(btCompoundShape* colShape, const btGImpactMeshShape* meshShape, btScalar depth) : m_colShape(colShape), m_gimpactShape(meshShape), m_depth(depth) {}
