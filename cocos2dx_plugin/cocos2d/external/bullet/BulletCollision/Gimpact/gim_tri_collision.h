...
struct GIM_TRIANGLE_CONTACT_DATA {
    ...
    GIM_TRIANGLE_CONTACT_DATA(const GIM_TRIANGLE_CONTACT_DATA &other) { copy_from(other); }
...
class GIM_TRIANGLE {
   public:
    ...
    SIMD_FORCE_INLINE GIM_AABB get_box() const { return GIM_AABB(m_vertices[0], m_vertices[1], m_vertices[2], m_margin); }
    SIMD_FORCE_INLINE void get_normal(btVector3 &normal) const { TRIANGLE_NORMAL(m_vertices[0], m_vertices[1], m_vertices[2], normal); }
