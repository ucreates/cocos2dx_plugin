...
PlayerMenuItemWin::PlayerMenuItemWin() : _parent(nullptr), _commandId(0), _hmenu(NULL), _menubarEnabled(true) {}
...
PlayerMenuServiceWin::PlayerMenuServiceWin(HWND hwnd) : _hwnd(hwnd), _menubarEnabled(true) {
    // create menu
...
PlayerMenuItem *PlayerMenuServiceWin::addItem(const std::string &menuId, const std::string &title, const std::string &parentId, int order /* = MAX_ORDER */) {
...
PlayerMenuItem *PlayerMenuServiceWin::addItem(const std::string &menuId, const std::string &title) { return addItem(menuId, title, ""); }
...
bool PlayerMenuServiceWin::removeItem(const std::string &menuId) { return removeItemInternal(menuId, true); }
