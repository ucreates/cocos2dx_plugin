...
PlayerMenuItemMac::PlayerMenuItemMac() : _parent(nullptr), _menuItem(nullptr), _menu(nullptr) {}
...
PlayerMenuItem *PlayerMenuServiceMac::addItem(const std::string &menuId, const std::string &title, const std::string &parentId, int order) {
...
PlayerMenuItem *PlayerMenuServiceMac::addItem(const std::string &menuId, const std::string &title) { return addItem(menuId, title, ""); }
...
void PlayerMenuServiceMac::setMenuBarEnabled(bool enabled) { __G_IS_MENUBAR_ENABLED__ = enabled; }
#pragma mark - private -
