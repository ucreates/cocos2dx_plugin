...
#ifdef __cplusplus
    _spAnimationState() : super(), events(0), createTrackEntry(0), disposeTrackEntry(0) {}
#endif
} _spAnimationState;
...
void _spTimeline_init(spTimeline* self, spTimelineType type, /**/
                      ...
                      void (*apply)(const spTimeline* self, spSkeleton* skeleton, float lastTime, float time, spEvent** firedEvents, int* eventsCount, float alpha));
