...
CCBKeyframe::CCBKeyframe() : _object(nullptr), _time(0.0f), _easingType(EasingType::INSTANT), _easingOpt(0.0f) {}
...
float CCBKeyframe::getTime() { return _time; }
void CCBKeyframe::setTime(float fTime) { _time = fTime; }
