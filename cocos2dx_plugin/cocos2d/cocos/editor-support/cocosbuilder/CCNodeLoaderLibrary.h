...
class CC_DLL NodeLoaderLibrary : public cocos2d::Ref {
   ...
   public:
     ...
     * @lua NA
     */
    CC_DEPRECATED_ATTRIBUTE static NodeLoaderLibrary *sharedNodeLoaderLibrary() {
        return NodeLoaderLibrary::getInstance();
    };
    /**
     * @js NA
     * @lua NA
     */
    CC_DEPRECATED_ATTRIBUTE static void purgeSharedNodeLoaderLibrary() {
     ...
     * @lua NA
     */
    CC_DEPRECATED_ATTRIBUTE static NodeLoaderLibrary *newDefaultCCNodeLoaderLibrary() {
        return NodeLoaderLibrary::newDefaultNodeLoaderLibrary();
    };
   private:
